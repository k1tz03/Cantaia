    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="mb-4">
        ...
        <input
          ...
          className={`h-[46px] w-full rounded-[10px] border border-[#27272A] bg-[#1C1C1F] px-4 text-sm text-[#FAFAFA] placeholder-[#71717A] outline-none transition-all focus:border-[#F97316] focus:shadow-[0_0_0_3px_rgba(249,115,22,0.12)] ${inviteData ? "cursor-not-allowed opacity-60" : ""}`}
        />
        {errors.email && (
      ...
      {/* Trial note */}
      <p className="mt-4 text-center text-xs leading-relaxed text-[#A1A1AA]">
        {t("trialInfo")}
      </p>
