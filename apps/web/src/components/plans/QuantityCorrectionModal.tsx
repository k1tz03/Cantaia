        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              <div className="bg-gray-100 rounded px-3 py-2 font-mono text-lg">{poste.quantite}</div>
              ...
              {showDetail && (
                <div className="mt-2 space-y-1">
                  {consensusValeurs.map((v) => (
                    <div key={v.provider} className="flex justify-between text-sm bg-gray-50 rounded px-3 py-1">
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="w-full border border-gray-200 rounded-lg px-3 py-2 mt-1 focus:outline-none focus:ring-2 focus:ring-[#C4A661] resize-none"
