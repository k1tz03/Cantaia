    ...
    <div className="space-y-4">
      {!estimationV2 && !estimatingV2 && !estimationV2Error && !hasAnalysis && (
        <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-amber-300 bg-amber-500/10 py-16">
          ...
          <p className="text-sm text-[#A1A1AA] max-w-md text-center mb-6">
      ...
      {estimatingV2 && (
        <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-[#27272A] bg-[#0F0F11] py-16">
          ...
          <p className="text-sm font-medium text-[#A1A1AA]">Estimation en cours...</p>
          <p className="mt-1 text-xs text-[#A1A1AA]">3 IA analysent votre plan en parallele. Cela peut prendre 30 a 60 secondes.</p>
        </div>
      )}
      ...
      {estimationV2Error && (
        <div className="rounded-lg border border-red-500/20 bg-red-500/10 p-6 text-center">
          ...
          <p className="text-sm font-medium text-red-700 dark:text-red-400 mb-2">{estimationV2Error}</p>
          <button
            onClick={onEstimate}
