...
export function PVSidePanel({
  ...
  return (
    <div className="hidden w-[35%] border-l border-[#27272A] bg-[#27272A] lg:flex lg:flex-col">
        ...
        {activeTab === "transcription" && (
          <div>
            {meeting.transcription_raw ? (
              <div className="rounded-md bg-[#0F0F11] p-4 text-sm leading-relaxed text-[#FAFAFA] shadow-sm">
                {meeting.transcription_raw}
              </div>
            ) : (
          ...
          <div>
            ...
            {allActions.map((action) => (
              <div
                ...
                className="mb-2 rounded-md border border-[#27272A] bg-[#0F0F11] p-3"
              >
