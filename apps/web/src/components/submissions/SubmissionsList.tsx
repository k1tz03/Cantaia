          ...
          className={`border-2 border-dashed rounded-2xl p-6 md:p-8 text-center transition-colors cursor-pointer ${
            dragOver
              ...
              : file
                ...
                : "border-[#27272A] hover:border-brand/50 bg-[#0F0F11]"
          }`}
          onDrop={handleDrop}
          onDragOver={(e) => {
            e.preventDefault();
        ...
        {isLoading ? (
          <div className="space-y-3">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="h-16 bg-[#27272A] rounded-xl animate-pulse"
              />
            ))}
          </div>
        ) : deduped.length === 0 ? (
          <div className="flex flex-col items-center py-10 text-center">
            <div className="w-14 h-14 rounded-full bg-[#27272A] flex items-center justify-center mb-3">
          ...
          <div className="space-y-2">
            <h2 className="text-xs font-semibold text-[#71717A] uppercase tracking-wide">
              {t("history")}
            </h2>
            ...
            {deduped.map((sub) => (
              <div
                key={sub.id}
                className="flex items-center gap-4 p-4 bg-[#0F0F11] border border-[#27272A] rounded-xl hover:border-brand/30 hover:bg-[#27272A]/50 transition-all group"
              >
                <button
                  onClick={() => onOpen(sub)}
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-medium text-sm text-[#FAFAFA] truncate">
                      {sub.name}
                    </p>
                  ...
                  <ChevronRight className="h-4 w-4 text-[#71717A] group-hover:text-[#71717A] transition-colors shrink-0" />
                </button>
                ...
                <button
                  ...
                  className="p-1.5 text-[#71717A] hover:text-red-500 rounded transition-colors opacity-0 group-hover:opacity-100"
                >
