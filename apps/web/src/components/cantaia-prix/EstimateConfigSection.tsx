    ...
    <div className="rounded-lg border border-[#27272A] bg-[#0F0F11] p-5">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div>
          ...
          <div className="relative">
            ...
            />
            <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-[#A1A1AA]">
              CHF/h
            </span>
          </div>
        </div>
            ...
            <button
              ...
              className={cn(
                ...
                config.margin_level === opt.value
                  ...
                  : "border-[#27272A] bg-[#0F0F11] text-[#A1A1AA] hover:bg-[#27272A]"
              )}
            >
              {opt.label}
            </button>
      ...
      <div className="mt-4">
        ...
        <textarea
          ...
          className="w-full rounded-md border border-[#27272A] bg-[#0F0F11] px-3 py-2 text-sm text-[#FAFAFA] placeholder:text-[#A1A1AA] focus:border-brand focus:outline-none focus:ring-1 focus:ring-brand resize-none"
        />
      </div>
    </div>
  );
