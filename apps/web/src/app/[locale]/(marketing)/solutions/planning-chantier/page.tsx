...
const PATH = "/solutions/planning-chantier";
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "chantier.solutionsPage.planning.seo" });
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
  return <SolutionPage locale={locale} solution="planning" />;
}
