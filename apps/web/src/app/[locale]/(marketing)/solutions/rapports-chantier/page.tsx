...
const PATH = "/solutions/rapports-chantier";
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "chantier.solutionsPage.rapports.seo" });
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
  return <SolutionPage locale={locale} solution="rapports" />;
}
