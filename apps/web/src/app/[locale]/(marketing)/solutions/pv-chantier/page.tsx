...
const PATH = "/solutions/pv-chantier";
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "chantier.solutionsPage.pv.seo" });
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
  return <SolutionPage locale={locale} solution="pv" />;
}
