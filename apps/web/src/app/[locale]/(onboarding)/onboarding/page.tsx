  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-4">
      ...
      <div className="mb-8 text-center">
        ...
        <p className="mt-1 text-sm text-slate-500">L'IA au service du chantier</p>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <button
                ...
                className="flex w-full items-center justify-center gap-3 rounded-lg border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-700 hover:bg-slate-50 disabled:opacity-50 transition-colors"
              >
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-200 px-3 py-2.5 text-sm text-slate-800 placeholder:text-slate-400 focus:border-[#1E3A5F] focus:outline-none focus:ring-1 focus:ring-[#1E3A5F]"
                />
              </div>
              <div>
                <label className="mb-1.5 block text-xs font-medium text-slate-700">
