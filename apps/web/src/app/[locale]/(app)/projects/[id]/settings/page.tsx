  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      <form onSubmit={handleSubmit} className="mt-8 max-w-3xl space-y-6">
        {/* General Info */}
        <fieldset className="rounded-md border border-slate-200 bg-white p-6">
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            <div className="sm:col-span-2">
              ...
              <input
                ...
                className="w-full rounded-md border border-slate-200 bg-white px-3 py-2 text-sm text-slate-800 focus:border-brand focus:outline-none focus:ring-1 focus:ring-brand/20"
              />
            </div>
            <div>
              <label className="mb-1.5 block text-sm font-medium text-slate-600">
              ...
              <div className="flex flex-wrap gap-2">
                {colorPresets.map((c) => (
                  <button
                    ...
                    className={`h-8 w-8 rounded-full border-2 transition-all ${form.color === c ? "border-slate-900 scale-110" : "border-transparent hover:scale-105"}`}
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                placeholder="mot-cle..."
                className="flex-1 rounded-md border border-slate-200 bg-white px-3 py-2 text-sm text-slate-800 focus:border-brand focus:outline-none focus:ring-1 focus:ring-brand/20"
              />
              <button type="button" onClick={addKeyword} className="rounded-md bg-slate-100 px-3 py-2 hover:bg-slate-200">
          ...
          <div className="mt-5">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 rounded-md border border-slate-200 bg-white px-3 py-2 text-sm text-slate-800 focus:border-brand focus:outline-none focus:ring-1 focus:ring-brand/20"
              />
              <button type="button" onClick={addSender} className="rounded-md bg-slate-100 px-3 py-2 hover:bg-slate-200">
                <Plus className="h-4 w-4 text-slate-500" />
              </button>
            </div>
            {form.email_senders.length > 0 && (
              <div className="mt-2 flex flex-wrap gap-2">
                {form.email_senders.map((s) => (
                  <span key={s} className="inline-flex items-center gap-1 rounded-full bg-slate-100 px-3 py-1 text-xs font-medium text-slate-600">
                    {s}
        ...
        <fieldset className="rounded-md border border-slate-200 bg-white p-6">
          ...
          <div className="flex items-center justify-between rounded-md border border-dashed border-slate-300 p-4">
            <p className="text-sm text-slate-500">{t("membersPlaceholder")}</p>
            <button
              type="button"
              className="inline-flex items-center gap-2 rounded-md bg-slate-100 px-3 py-2 text-sm font-medium text-slate-600 hover:bg-slate-200"
            >
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href={`/projects/${project.id}`}
            className="rounded-md px-6 py-2 text-sm font-medium text-slate-500 hover:bg-slate-100"
          >
            {tc("cancel")}
          </Link>
          {saveMessage && (
      ...
      {/* ── Zone dangereuse ── */}
      <div className="mt-12 max-w-3xl rounded-md border border-red-200 bg-red-50/50 p-6">
          ...
          <div className="flex-1">
            ...
            {!showDeleteDialog ? (
              <button
                ...
                className="mt-4 inline-flex items-center gap-2 rounded-md border border-red-300 bg-white px-4 py-2 text-sm font-medium text-red-600 hover:bg-red-50"
              >
              ...
              <div className="mt-4 space-y-3">
                ...
                <input
                  ...
                  className="w-full rounded-md border border-red-300 bg-white px-3 py-2 text-sm text-slate-800 focus:border-red-500 focus:outline-none focus:ring-1 focus:ring-red-200"
                />
                <div className="flex items-center gap-3">
                  <button
                    type="button"
